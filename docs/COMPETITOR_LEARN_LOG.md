...
Clones: `../paper-rec-competitors/`

| # | Project | Status | Integrated into Paper_Rec |
|---|---------|--------|---------------------------|
| 1 | AutoResearchClaw | done | citation-verify, latex-export, skill wiki commands |
...
| 4–18 | (pending clones + per-repo passes) | queued | |
