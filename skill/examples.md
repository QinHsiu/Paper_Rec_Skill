...
## Example 4: Persist to Wiki / 写入阅读库

**User** (after a report):
> 把 Top 2 写入 Wiki，标记为 reading

### Module 4

1. Build JSON with the two papers (fields aligned with output-template).
2. Run:
