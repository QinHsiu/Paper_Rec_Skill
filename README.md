...
[![Workspace](https://img.shields.io/badge/workspace-v2.44.0-0F766E?style=for-the-badge&labelColor=1A2332)](VERSION)
[![paper-rec](https://img.shields.io/badge/paper--rec-v1.21.0-1A2332?style=for-the-badge)](skill/VERSION)
...
角色：Brain · Retrieve · Plan · Verify · Experiment · Accept · Write（+ Critique · Reflect · Draw）。详见 [skill-agents/README.md](skill-agents/README.md)。
